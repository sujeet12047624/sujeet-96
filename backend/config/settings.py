"""
Django settings for UPSC Blog Application.
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-change-me-in-production-x9k2m3n4b5v6c7x8z9",
)
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "upsc_blog"),
...
# ---------------------------------------------------------------------------
# SimpleJWT – HttpOnly cookie transport
# ---------------------------------------------------------------------------
SIMPLE_JWT = {
...
if USE_S3:
    ...
    AWS_STORAGE_BUCKET_NAME = os.environ.get("AWS_STORAGE_BUCKET_NAME", "upsc-blog-media")
...
QDRANT_COLLECTION_NAME = os.environ.get("QDRANT_COLLECTION_NAME", "upsc_blog_embeddings")
